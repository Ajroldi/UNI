...
[10:40] Si può scegliere tra SVD “full” ($\mathrm{full\_matrices} = \mathrm{True}$) e SVD “thin” ($\text{full\_matrices}=\text{False}$). Si confronta il risultato con la funzione standard che calcola la pseudo-inversa, verificando una differenza dell’ordine di $10^{-15}$.
